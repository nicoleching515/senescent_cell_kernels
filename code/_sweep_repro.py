...
RESULTS = "/workspace/results/repro_2026-08-21/sweep"
LAM_TRUE = 30.0
N_BOOT = 400
...
def main():
    ...
    alldf.to_csv("/workspace/results/repro_2026-08-21/sweep_all.csv", index=False)
    print(f"\nwrote /workspace/results/repro_2026-08-21/sweep_all.csv  "
